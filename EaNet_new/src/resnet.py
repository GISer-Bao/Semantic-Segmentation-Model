...
class Resnet101(nn.Module):
    def __init__(self, in_channel=3, stride=32, *args, **kwargs):
    ...
    def init_weight(self):
        ...
        #state_dict = torch.load('/home/hlx/MyResearch/Segmentation/pretrained/DANet101.pth.tar')['state_dict']
        #state_dict = torch.load('/home/hlx/MyResearch/Segmentation/pretrained/resnet101.pth')
        
        state_dict = torch.load(r"E:\segmentation_repo\EaNet\models\resnet101.pth")
        # state_dict = torch.load('/home/hlx/MyResearch/Segmentation/pretrained/model_best.pth.tar')['state_dict']
        ...
        for k, v in self_state_dict.items():
            if 'module.'+k in state_dict.keys():
                mk = 'module.'+k
                self_state_dict.update({k: state_dict[mk]})
                # print('load {}'.format(k))
    ...
    def get_params(self):
        ...
        for name, param in self.named_parameters():
            if 'bn' in name or 'downsample.1' or 'bias' in name:
...
class Resnet50(nn.Module):
    ...
    def init_weight(self):
        ...
        state_dict = torch.load(r"E:\segmentation_repo\EaNet\models\resnet50.pth")
        # state_dict = torch.load('/home/hlx/MyResearch/Segmentation/ELKPPNet/Net3/res50elkpp_edge_8scales/model_final_457.pth')

        #print('resnet50 load ./model.pth')
        self_state_dict = self.state_dict()
        for k, v in self_state_dict.items():
            if k in state_dict.keys():
                self_state_dict.update({k: state_dict[k]})
