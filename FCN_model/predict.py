...
if __name__ == '__main__':
    ...
    weights_path = r"E:\GID_experiment\allocate_data_492\train_fcn\save_weights_fcn\fcn_resnet101_best_model_epoch15_dice0.7571937441825867.pth"
    imgs_path = r"E:\GID_experiment\allocate_data_492\test\image_NirRGB"
    masks_path = os.path.dirname(imgs_path) + "\\test_result_fcn-resnet101_epoch15"
    ...
    for img in tqdm.tqdm(imgs_name_list, desc='Precessing'):
        mask = main_fcn(img,weights_path)
