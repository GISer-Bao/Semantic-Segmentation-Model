...
def main(args):
    ...
    val_loader = torch.utils.data.DataLoader(val_dataset,
                                             ...
                                             pin_memory=True)
    # model 需要修改
    model = UNet(in_channels=args.in_ch, num_classes=num_classes, base_c=64)
    model.to(device)
...
if __name__ == '__main__':
    ...
    args.model_path = r"E:\GID_experiment\allocate_data_492\train_unet\save_weights_unet"    
    args.in_ch = 4
    main(args)
