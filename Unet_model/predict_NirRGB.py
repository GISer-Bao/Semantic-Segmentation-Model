...
if __name__ == '__main__':
    ...
    weights_path = r"E:\GID_experiment\allocate_data_492\train_unet\save_weights_unet\unet_best_model_epoch6_dice0.8191751837730408.pth"
    imgs_path = r"E:\GID_experiment\allocate_data_492\test\image_NirRGB"
    masks_path = os.path.dirname(imgs_path) + "\\test_result_unet_epoch6"
